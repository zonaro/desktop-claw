...
![screenshot of the GitHub Desktop settings menu with the "Use Git Credential Manager" checkbox outlined](/docs/documentation/assets/git-credential-manager.png)
...
![screenshot of a prompt showing the option to sign in with your browser to an Atlassian account](/docs/documentation/assets/bitbucket-prompt.png)
