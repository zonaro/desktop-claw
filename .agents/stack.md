...
`docs/technical/` (rebase-flow, feature-flagging, oauth, pull-requests, dialogs, e2e-smoke-tests...), `docs/contributing/` (setup, styleguide, linting, tooling...), `docs/process/` (release-planning, testing...), `docs/known-issues.md`, `docs/cli.md`. Úteis para consulta antes de mexer em área desconhecida.
