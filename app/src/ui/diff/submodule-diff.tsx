...
export class SubmoduleDiff extends React.Component<ISubmoduleDiffProps> {
  ...
  private renderOpenSubmoduleAction() {
    ...
    return (
      <span>
        <SuggestedAction
          title="Open this submodule on Desktop Claw"
          description="You can open this submodule on Desktop Claw as a normal repository to manage and commit any changes in it."
